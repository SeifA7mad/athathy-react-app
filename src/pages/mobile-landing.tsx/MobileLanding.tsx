      ...
      <main className='flex flex-col gap-[86px] bg-[#F5F5F5] py-[4rem] px-[1.5rem]'>
        ...
        <div className='flex flex-col gap-[26px] py-[32px] px-[23.5008px] bg-white rounded-[16px]'>
          ...
          <p className='text-OuterSpace leading-[24px] text-base'>
            ...
            mission is to make furniture shopping simple, convenient, and
            accessible to everyone. Our e-commerce platform offers a wide range
            of household furniture products from partnered brands, providing a
            connection between these brands and a broader customer base.
          </p>
        </div>
        ...
        <div className='flex flex-col gap-[26px] w-full'>
          ...
          <p className='text-OuterSpace leading-[24px] text-base'>
            Our platform is designed to cater to all household furniture needs,
            with a wide selection of brands and products all available under one
            roof.
          </p>
          {/* Cards Carousel */}
          <CardsCarousel
